...
IMAGES_STORE = os.path.join(BASE_DIR, 'imagesstored')
...
CLUSTERS_STORE = os.path.join(BASE_DIR, 'clusters')
if not os.path.exists(CLUSTERS_STORE):
    os.makedirs(CLUSTERS_STORE)
